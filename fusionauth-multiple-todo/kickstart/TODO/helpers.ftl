  ...
  <div class="${rowClass}">
    <div class="${colClass}">
      <div class="panel" data-in-progress>
        ...
        [#if client_id?has_content && client_id?matches("e9fdb985-9173-4e01-9d73-ac2d60d1dc8a")]
          <img id="imgThemeLogo" alt="logo" src="https://media.codingcat.dev/image/upload/v1720531022/FusionAuth/todo_1.png" height="100%" width="100%" />
        [/#if]
        [#if client_id?has_content && client_id?matches("e9fdb985-8675-4e01-9d73-ac2d60d1dc8b")]
          <img id="imgThemeLogo" alt="logo" src="https://media.codingcat.dev/image/upload/v1720531022/FusionAuth/todo_2.png" height="100%" width="100%" />
        [/#if]
        </div>
